...
*/}
      {showFicha ? (
        <>
          <FichaPersonal onAccion={handleFichaData} />
          {fichaData && (
            <div className="ficha-data-preview">
              <h3>Datos Guardados:</h3>
              <p><strong>Nombre completo:</strong> {fichaData.nombre} {fichaData.apellido}</p>
              <p><strong>Email:</strong> {fichaData.email}</p>
              <p><strong>Teléfono:</strong> {fichaData.telefono}</p>
            </div>
          )}
        </>
      ) : (
